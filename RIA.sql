...
INSERT INTO `dogadaj` VALUES (1,'2017-01-01','docek nove godine',123456789),(2,'2017-01-28','zadnja subota prvog mjeseca',123456787),(3,'2017-01-13','party za petak 13.',123456788);
...
) ENGINE=InnoDB AUTO_INCREMENT=123456834 DEFAULT CHARSET=cp1250 COLLATE=cp1250_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=cp1250 COLLATE=cp1250_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `korisnik` VALUES (1,'admin','korisnik@gmail.com','Filip'),(2,'root','lol@gmail.com','lolich'),(3,'tn','tn@gmail.com','toni'),(4,'12345','dmakovac@gmail.com','David'),(80,'$2y$08$UbBLOcVtHO9MrAcVJdqXDuKSgP3j4fNjRnurjUmKVu6LUL5L67S/S','davidmakovac95@gmail.com','David Makovac');
...
) ENGINE=InnoDB AUTO_INCREMENT=987654375 DEFAULT CHARSET=cp1250 COLLATE=cp1250_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-01-08 12:31:10
